...
namespace Example_Cosmos_DB_Gremlin_API
{
    /// <summary>
    ...
    class Program
    {
        ...
        // Replace the values in these variables to your own.
            private static string hostname = "angelpe-example-cosmos-db-gremlin-api.gremlin.cosmosdb.azure.com";
            private static int port = 443;
            private static string authKey = "<It's called the PRIMARY KEY in the Azure portal>";
